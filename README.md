...
- 김광호 - 프로필 페이지, 모달
- 김동규 - 와인 목록 페이지, 카드 컴포넌트
- 오성준 - 회원가입 페이지, 모달 
- 윤수현 - 와인 상세 페이지, 카드 컴포넌트
- 정한주 - 로그인 페이지, GNV 컴포넌트
- 멘토님
    
## 프로젝트 수행 절차 및 방법
<img src="https://github.com/user-attachments/assets/6d702a0d-2f2a-4643-befc-8a1fbb6bca75" width=70%>
