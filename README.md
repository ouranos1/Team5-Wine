...
### 🍷 프로젝트를 마치며
와인이라는 특정 주제를 다루며, 다양한 기능을 통해 사용자에게 가치를 제공하는 방법을 깊이 경험할 수 있었습니다. 특히, 구글과 카카오 간편 로그인 기능 같은 고난이도 작업을 진행하면서 어려움도 많았지만, 그 과정에서 크게 성장할 수 있었습니다. 또한, 컴포넌트 사용의 장점을 직접 체감하며, 효율적인 개발의 중요성을 깨달았습니다. 이번 프로젝트에서 얻은 피드백을 바탕으로, 앞으로 더 나은 프로젝트를 개발하기 위해 지속적으로 보완해 나갈 계획입니다.
