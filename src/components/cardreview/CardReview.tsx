    ...
    <>
      {detail && (
        <div className="soohyun-card">
          ...
          <ModalReview isModalOpen={isModalOpen} closeModal={handleCloseModal} wineName="와인 이름" wineId={detail?.wineId} ReviewData={convertReviewListToResponseBody(detail, detail?.wineId)} />
        </div>
      )}
    </>
  );
