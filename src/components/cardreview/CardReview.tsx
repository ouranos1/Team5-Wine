      ...
      {detail && (
        <div className="soohyun-card">
          <div className="soohyun-header">
            ...
            <div>
              {userData.user.id === detail.user.id && (
          ...
          <ModalReview isModalOpen={isModalOpen} closeModal={handleCloseModal} wineName="와인 이름" wineId={detail?.wineId} ReviewData={convertReviewListToResponseBody(detail, detail?.wineId)} showButton={true} />
        </div>
      )}
    </>
  );
