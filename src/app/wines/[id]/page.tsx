        ...
        <div className="wine-content">
          ...
          <div className="wine-position">
            <div className="a">
              ...
              <div> {detail.reviewCount > 0 ? detail.reviews.map((review) => <CardReview key={review.id} reviewId={review.id} />) : <div className="no-reviews">리뷰 없음냥</div>}</div>

              <div className="modal-review">
                <ModalReview isModalOpen={isModalOpen} closeModal={handleOpenModal} wineName="와인 이름" wineId={id} showButton={false} />
              </div>
            </div>
          </div>
        </div>
